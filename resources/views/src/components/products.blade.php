    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        @foreach ([1, 2, 3, 4, 5, 6] as $item)
            <div class="bg-white shadow-lg rounded-lg p-4 transition-transform duration-300 ease-in-out transform hover:scale-105 hover:-rotate-3">
                <img src="https://pngimg.com/d/dress_shirt_PNG8117.png" class="w-full h-auto object-cover object-center rounded-md" alt="Product Image">
                <h3 class="text-xl font-semibold text-gray-800 mt-4">Product Title {{ $item }}</h3>
                ...
                <div class="flex justify-between items-center mt-4">
                    <a href="#" class="text-green-500 hover:text-green-600 font-semibold">View Details</a>
                    <a href="#" class="text-green-500 hover:text-green-600 font-semibold">Add to Cart</a>
                </div>
            </div>
        @endforeach
    </div>
